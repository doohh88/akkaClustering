 ...
 */
public class DistCifarDataSetIterator extends RecordReaderDataSetIterator {
    ...
    protected int initCursor = 0;

    /** Loads images with given  batchSize, numExamples, & version returned by the generator. */
    public DistCifarDataSetIterator(int batchSize, int numExamples,  boolean train, DistInfo distInfo) {
        this(batchSize, numExamples, new int[]{height, width, channels}, CifarLoader.NUM_LABELS, null, 0, train, distInfo);
    }

    /** Loads images with given  batchSize, numExamples, & imgDim returned by the generator. */
    public DistCifarDataSetIterator(int batchSize, int numExamples, int[] imgDim, DistInfo distInfo) {
        this(batchSize, numExamples, imgDim, CifarLoader.NUM_LABELS, null, 0, true, distInfo);
    }

    /** Loads images with given  batchSize, numExamples, imgDim & version returned by the generator. */
    public DistCifarDataSetIterator(int batchSize, int numExamples, int[] imgDim, boolean train, DistInfo distInfo) {
        this(batchSize, numExamples, imgDim, CifarLoader.NUM_LABELS, null, 0, train, distInfo);
    }

    /** Loads images with given  batchSize & numExamples returned by the generator. */
    public DistCifarDataSetIterator(int batchSize, int numExamples, DistInfo distInfo) {
        this(batchSize, numExamples, new int[]{height, width, channels}, CifarLoader.NUM_LABELS, null, 0, true, distInfo);
    }

    /** Loads images with given  batchSize & imgDim returned by the generator. */
    public DistCifarDataSetIterator(int batchSize, int[] imgDim, DistInfo distInfo)  {
        this(batchSize, CifarLoader.NUM_TRAIN_IMAGES, imgDim, CifarLoader.NUM_LABELS, null, 0, true, distInfo);
    }

    /** Loads images with given  batchSize, numExamples, imgDim & version returned by the generator. */
    public DistCifarDataSetIterator(int batchSize, int numExamples, int[] imgDim, int normalizeValue, boolean train, DistInfo distInfo) {
        this(batchSize, numExamples, imgDim, CifarLoader.NUM_LABELS, null, normalizeValue, train, distInfo);
    }
     ...
     * */
    public DistCifarDataSetIterator(int batchSize, int numExamples, int[] imgDim, int numPossibleLables, ImageTransform imageTransform, int normalizeValue, boolean train, DistInfo distInfo) {
        ...
        this.initCursor = CifarLoader.NUM_TRAIN_IMAGES / distInfo.getRouterInfo().getNProcServer() * distInfo.getRoleIdx();
        this.exampleCount = this.initCursor;
    }
