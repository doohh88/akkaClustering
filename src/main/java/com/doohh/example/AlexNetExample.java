...
public class AlexNetExample {
     ...
     protected static int numLabels = CifarLoader.NUM_LABELS;
	    ...
	    public static void main(String[] args) throws Exception {
	        ...
	        MultipleEpochsIterator cifar = new MultipleEpochsIterator(nEpochs, new CifarDataSetIterator(batchSize, numTrainExamples, new int[]{HEIGHT, WIDTH, CHANNELS}, numLabels, null, normalizeValue, true));
	        MultipleEpochsIterator cifarTest = new MultipleEpochsIterator(1, new CifarDataSetIterator(batchSize, numTestExamples, new int[] {HEIGHT, WIDTH, CHANNELS}, normalizeValue, false));
